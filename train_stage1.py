...
from mydatasets.mydataset import MyPoseDataset, MyPoseCollateFn 
...
def main(unet_additional_kwargs: Dict = {},):
    ...
    dataset = MyPoseDataset(
        data_json_path="/opt/data/private/Datasets/final_dance/train.json", # 新增arg: 包含图像序列的json
        pose_json_path="/opt/data/private/Datasets/final_dance/keypoints_results.json", # 新增arg: 包含姿态的json
        image_folder_path="/opt/data/private/Datasets/final_dance/imgs", # 新增arg: 图像文件夹
    )


    train_dataloader = torch.utils.data.DataLoader(
        dataset, shuffle=True, collate_fn=MyPoseCollateFn, batch_size=args.train_batch_size, num_workers=8,
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with torch.no_grad():
                ...
                pose_coordinate = batch["pose_coordinate"]
            ...
            with accelerator.accumulate(prior_model):
                model_pred = prior_model(
                    ...
                    input_imgs_proj_embeds=imgs_proj_embeds,
                    input_masked_label_embeds = masked_label_embeds,
                    attention_mask=None,
